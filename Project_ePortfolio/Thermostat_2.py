...
class TemperatureMachine:
    ...
    def updateLights(self):
        ...
        self.indicator.update(temp, self.setPoint)

        if DEBUG:
            print(f"[LED UPDATE] Temp: {temp}, SetPoint: {self.setPoint}")
    ...
    def setupSerialOutput(self):
       output = f"{self.current_state.id},{round(self.getFahrenheit(), 1)},{self.setPoint}"        
       return output
